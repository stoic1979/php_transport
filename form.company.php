...
<script type = "text/javascript" >
	function validateCompany(){ 
		...
		var pin_code =  document.forms["frmCompany"]["pin_code"].value; 
...
<form name = "frmCompany" method="POST" action="save.company.php"  onsubmit = "return validateCompany();">
	<table cellspacing="5" cellpadding="5">
		...
		?>
			...
			<tr>
				<td> State </td>
				<td><input type = "text" name = "state" value= "<?=$vo->state?> "/></td>
			</tr>
			<tr>
				<td> Pin Code </td>
				<td><input type = "text" name = "pin_code" value= "<?=$vo->pin_code?> "/></td>
			</tr>
			<tr>
				<td> Country </td>
				<td><input type = "text" list = "countryList" name = "country" value= "<?=$vo->country?> "/>
		...
		<?}else{?>
			...
			<tr>
				<td> Country </td>
				<td><input type = "text" name = "country" list = "countryList" />
				<datalist id = "countryList">
				   <option value="" selected="selected">Select Country</option>
					<option value="Afghanistan" data-alternative-spellings="AF افغانستان">Afghanistan</option>
					<option value="Åland Islands" data-alternative-spellings="AX Aaland Aland" data-relevancy-booster="0.5">Åland Islands</option>
