...
<a href="form.expense.php?type=<?php echo $expense_type; ?>" class="btn btn-info">Add Expense</a><br>
...
?>
	...
	<tbody>
<?}
else echo "<tr><td colspan='9'><center><br><br><br><b>No Expenses are added yet.</b></center></td></tr>";
?>
</table>
<?
if($page != 1){
?>&nbsp;&nbsp;<a href="expense.php?page=<?=$prev?>" style="margin-right:20px">Prev</a>
<?}
for ($p =1; $p<=$pages ; $p++){
 ?>&nbsp;&nbsp;<a href="expense.php?page=<?=$p?>"><?=$p."/".$pages?></a>
<?
}
if($page != $pages){
?><a href="expense.php?page=<?=$next?>" style="margin-left:20px">Next</a>
<a href="expense.php?page=<?=$pages?>"style="margin-left:12px">Last</a><br />
<?}
?>
<?php
include("footer.php");
